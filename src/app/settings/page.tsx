...
export default function SettingsLayout({ children }: { children: React.ReactNode }) {
  ...
  if (loading) {
    return (
      <p className={`p-8 ${isLight ? "text-gray-800" : "text-gray-200"}`}>
        Cargando perfil...
      </p>
    );
  }
          ...
          <>
            ...
            >
              ...
              <div className="flex-1 space-y-3 text-center sm:text-left">
                <div
                  className={`text-2xl font-bold flex items-center justify-center sm:justify-start gap-2 text-red-500`}
                >
